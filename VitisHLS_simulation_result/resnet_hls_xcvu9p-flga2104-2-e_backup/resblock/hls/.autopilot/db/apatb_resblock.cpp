...
// wrapc file define:
#define AUTOTB_TVIN_input_r "../tv/cdatafile/c.resblock.autotvin_input_r.dat"
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.resblock.autotvout_input_r.dat"
#define AUTOTB_TVIN_output_r "../tv/cdatafile/c.resblock.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.resblock.autotvout_output_r.dat"
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.resblock.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.resblock.autotvout_gmem.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.resblock.autotvout_gmem.dat"
...
extern "C"
void resblock_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_resblock_hw(void* __xlx_apatb_param_input_r, void* __xlx_apatb_param_output_r)
{
  ...
  port2.param = { __xlx_apatb_param_input_r, __xlx_apatb_param_output_r };
  port2.mname = { "input_r", "output_r" };
  port2.nbytes = { 802816, 802816 };
  for (size_t off = 0, i = 0; i < port2.nbytes.size(); ++i) {
    port2.offset.push_back(off);
    off += hls::sim::divide_ceil(port2.nbytes[i], port2.asize);
  }
  __xlx_offset_byte_param_input_r = port2.offset[0]*4;
  __xlx_offset_byte_param_output_r = port2.offset[1]*4;
  ...
  try {
    ...
    resblock_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r);
